...
/// @details This class implements a simple evaluation function for the game
/// board
///          based on positional heuristics.
...
///          based on the number of possible moves for each player.
