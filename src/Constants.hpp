...
#ifndef OTHELLO_CONSTANTS_HPP
#define OTHELLO_CONSTANTS_HPP
...
namespace othello {
  ...
  inline constexpr uint64_t LEFT_EDGE_MASK = 0x101010101010101ULL; // Mask for the left edge of the board
  inline constexpr uint64_t RIGHT_EDGE_MASK = 0x8080808080808080ULL; // Mask for the right edge of the board
  inline constexpr uint64_t TOP_EDGE_MASK = 0xFF00000000000000ULL; // Mask for the top edge of the board
  inline constexpr uint64_t BOTTOM_EDGE_MASK = 0x00000000000000FFULL; // Mask for the bottom edge of the board

} // namespace othello
#endif // OTHELLO_CONSTANTS_HPP
