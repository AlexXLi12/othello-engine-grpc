...
namespace othello {
  ...
  // These functions are used to get all flipped discs in each direction
  uint64_t get_west_flips(uint64_t my_board, uint64_t op_board, uint64_t empty);
  uint64_t get_east_flips(uint64_t my_board, uint64_t op_board, uint64_t empty);
  uint64_t get_north_flips(uint64_t my_board, uint64_t op_board, uint64_t empty);
  uint64_t get_south_flips(uint64_t my_board, uint64_t op_board, uint64_t empty);
  uint64_t get_north_west_flips(uint64_t my_board, uint64_t op_board, uint64_t empty);
  uint64_t get_north_east_flips(uint64_t my_board, uint64_t op_board, uint64_t empty);
  uint64_t get_south_west_flips(uint64_t my_board, uint64_t op_board, uint64_t empty);
  uint64_t get_south_east_flips(uint64_t my_board, uint64_t op_board, uint64_t empty);
